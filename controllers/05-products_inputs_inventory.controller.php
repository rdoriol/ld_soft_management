            ...
            try {
                if(isset($_POST["btn_input_product_submit"])) { 
                    ...
                    self::ctrCreateSupplierInvoice("supplier_invoices"); 
                                    // Se lista y captura el úlitmo "id_supplier_invoice" para darle entrada en la tabla "inputs_product"
                    ...
                    foreach($rowsNumbers as $rowNumber) {  
                        ...
                        if(!empty($_POST["id_product_item" . $rowNumber])) {
                            ...
                            if(!empty($_POST["select_supplier"]) && !empty($_POST["amount_item". $rowNumber]) && !empty($_POST["price_item" . $rowNumber])) {   
                                    ...
                                    // Condición para validar formatos numéricos de campos
                                if(!is_numeric($_POST["amount_item". $rowNumber]) || !is_numeric($_POST["price_item" . $rowNumber]) || !is_numeric($_POST["discount_item" . $rowNumber])) {
                                    ...
                                    $data = array(  "token_product_inputs"=> $token_product_inputs,
