    ...
    <li>
        <form class="general_searchs_forms" id="" action="" method="post">     
            ...
            <select class="bar_search" id="" name="select_item">
                ...
                <option value="si.input_number">Nº Entrada</option>
                <option value="name_supplier">Nombre Proveedor</option>
                <option value="created_date_supplier_invoice">Fecha de entrada</option>           
            </select>
